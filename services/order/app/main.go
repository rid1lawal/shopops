...
import (
	...
	"github.com/rid1lawal/shopops/services/order/internal/database"
	"github.com/rid1lawal/shopops/services/order/internal/logger"
...
func main() {
	...
	orderRepository := repository.NewPostgresRepository(dbPool)
	...
	case sig := <-shutdown:
		...
		if err := srv.Shutdown(ctx); err != nil {
			...
			if err := srv.Close(); err != nil {
				log.Error("forced shutdown failed", slog.String("error", err.Error()))
			}
		}
